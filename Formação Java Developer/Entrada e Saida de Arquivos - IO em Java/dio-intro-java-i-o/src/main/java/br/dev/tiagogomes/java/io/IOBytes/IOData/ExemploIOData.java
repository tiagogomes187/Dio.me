package br.dev.tiagogomes.java.io.IOBytes.IOData;
...
public class ExemploIOData {
	public static void incluirProduto() throws IOException {
		...
		File f = new File("/mnt/Documents/peca-de-roupa.bin");
	...
	public static void lerProduto(String caminhoArquivo) throws IOException {
		...
		System.out.print("Total valor das peças.: R$ " + (quantidade * preco));
