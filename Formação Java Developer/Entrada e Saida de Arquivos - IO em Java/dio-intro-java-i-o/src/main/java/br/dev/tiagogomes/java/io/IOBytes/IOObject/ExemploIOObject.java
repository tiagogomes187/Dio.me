package br.dev.tiagogomes.java.io.IOBytes.IOObject;
...
//       ObjectOutputStream oos = new ObjectOutputStream(os);
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		//serealizacao();
		desserializacao("/mnt/Conteúdos Estudantil/DIO/Formação Java Developer/Entrada e Saida de Arquivos - IO em Java/dio-intro-java-i-o/gato");
