package br.dev.tiagogomes.java.io.IOBytes;
...
public class ExemploIOBytes {
	public static void copiarArquivo() throws IOException {
		File f = new File("/mnt/Conteúdos Estudantil (mnt)/DIO/Formação Java Developer/Entrada e Saida de Arquivos - IO em Java/dio-intro-java-i-o/recomendacoes-copy.txt");
